...
const en = {
  ...
  zeroRiskSentConfirmationBody: "After sending a Zero Risk prompt in ChatGPT, require a second confirmation in the Launcher. Turn this off to let the Codex Zero Risk connector confirm the turn automatically.",
  ...
  manualPromptInstructionAutomaticConfirmation: "The prompt is already in your clipboard. Paste it into the open ChatGPT tab, choose the model and effort you want, select the Codex Zero Risk connector, then send it. The connector will confirm this turn automatically.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  zeroRiskSentConfirmationBody: "在 ChatGPT 中发送 Zero Risk 提示后，要求再回到启动器确认一次。关闭后，由 Codex Zero Risk 连接器自动确认本回合。",
  ...
  manualPromptInstructionAutomaticConfirmation: "提示已复制到剪贴板。请将其粘贴到打开的 ChatGPT 标签页，选择所需模型和 effort，再选择 Codex Zero Risk 连接器并发送。连接器会自动确认本回合。",
...
const ja: Record<keyof typeof en, string> = {
  ...
  zeroRiskSentConfirmationBody: "ChatGPT で Zero Risk のプロンプトを送信した後、ランチャーでもう一度確認します。オフにすると Codex Zero Risk コネクタがターンを自動確認します。",
  ...
  manualPromptInstructionAutomaticConfirmation: "プロンプトはクリップボードにコピー済みです。開いている ChatGPT タブに貼り付け、モデルと effort、Codex Zero Risk コネクタを選んで送信してください。コネクタがこのターンを自動確認します。",
...
const ko: Record<keyof typeof en, string> = {
  ...
  zeroRiskSentConfirmationBody: "ChatGPT에서 Zero Risk 프롬프트를 전송한 뒤 런처에서 한 번 더 확인합니다. 끄면 Codex Zero Risk 커넥터가 턴을 자동으로 확인합니다.",
  ...
  manualPromptInstructionAutomaticConfirmation: "프롬프트가 이미 클립보드에 복사되어 있습니다. 열려 있는 ChatGPT 탭에 붙여넣고 원하는 모델과 effort, Codex Zero Risk 커넥터를 선택한 뒤 전송하세요. 커넥터가 이 턴을 자동으로 확인합니다.",
...
const zhTW: Record<keyof typeof en, string> = {
  ...
  zeroRiskSentConfirmationBody: "在 ChatGPT 中傳送 Zero Risk 提示後，要求再回到啟動器確認一次。關閉後，由 Codex Zero Risk 連接器自動確認本回合。",
  ...
  manualPromptInstructionAutomaticConfirmation: "提示已複製到剪貼簿。請將其貼到開啟的 ChatGPT 分頁，選擇所需模型與 effort，再選擇 Codex Zero Risk 連接器並傳送。連接器會自動確認本回合。",
