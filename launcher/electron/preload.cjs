...
contextBridge.exposeInMainWorld("codexWebLauncher", {
  ...
  apiAccessUpstreamSave: (input) => ipcRenderer.invoke("launcher:api-access-upstream-save", input),
  apiAccessUpstreamDelete: (input) => ipcRenderer.invoke("launcher:api-access-upstream-delete", input),
  apiAccessUpstreamModels: (input) => ipcRenderer.invoke("launcher:api-access-upstream-models", input),
